...
fun AccountEditDialog(
    ...
    FormDialog(
        title = if (profile.label.isBlank()) "アカウントを追加" else "アカウントを編集",
        onDismiss = onDismiss,
        ...
        Text("二要素認証の方式", style = MaterialTheme.typography.titleSmall)
        ...
        Text("パスワード", style = MaterialTheme.typography.titleSmall)
        OutlinedTextField(
            value = password,
